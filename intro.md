    ...
    <div class="container px-4 py-2">
     <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
      <div class="feature col div-choice">
            <div class="scenario-description">Exercise 2.1: Working with Partitions</div>
            <ul>
            ...
            <ul>
              ...
              <li><span class="scenario-objective">Create a new table that allows querying videos by title and year using a composite partition key</span></li>
